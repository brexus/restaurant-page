function loadMenu() {
    ...
    p1.innerText =
        "San Marzano Italian tomato sauce, Fior di latte mozzarella, Prosciutto Cotto ham (traditional Italian cooked ham)";
    ...
    p1 = document.createElement("p");
    p1.innerText =
        "Italian San Marzano tomato sauce, Fior di latte mozzarella, Pancetta (Italian ripening bacon), red onion, garlic, chili pepper";
    ...
    p1 = document.createElement("p");
    p1.innerText =
        "sauce, mozzarella cheese, ham, corn, champignons, and oregano";
